...
class ShippingCard extends Card
{
    public function getOptions(): array
    {
        ...
        ->where('status', ShippingStatus::SHIPPING)
        ->groupBy('date')
        ->pluck('revenue')
        ->toArray();
    ...
    public function getViewData(): array
    {
        ...
        return array_merge(parent::getViewData(), [
            'content' => view(
                'plugins/logistics::admin.reports.widgets.shipping-card',
                [
                    'revenue' => $total,
                    'result' => 0,
                ]
    ...
    {
        return trans('plugins/logistics::logistics.reports.shipping');
    }
}
