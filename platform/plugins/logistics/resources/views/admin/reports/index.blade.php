...
@push('header-action')
    <div class="d-flex gap-2">
        ...
        <x-core::button
            ...
            data-href="{{ route('logistics.report.index') }}"
...
@section('content')
    <div id="report-stats-content">
        @include('plugins/logistics::admin.reports.ajax')
    </div>
    @include('plugins/logistics::admin.reports.partials.widget-config-modal')
@endsection
