...
namespace Botble\Inventory\Domains\Report\Http\Controllers;
...
class ReportController extends BaseController
{
    public function __construct()
    {
        $this
            ->breadcrumb()
            ->add(trans(trans('plugins/inventory::inventory.report.name')), route('inventory.report.index'));
    }

    public function index(PackingTable $table)
    {
        $this->pageTitle(trans('plugins/inventory::inventory.report.name'));
