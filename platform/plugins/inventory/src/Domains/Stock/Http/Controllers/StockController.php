...
namespace Botble\Inventory\Domains\Stock\Http\Controllers;
...
class StockController extends BaseController
{
    public function __construct()
    {
        $this
            ->breadcrumb()
            ->add(trans(trans('plugins/inventory::inventory.stock.name')), route('inventory.stock.index'));
    }

    public function index(PackingTable $table)
    {
        $this->pageTitle(trans('plugins/inventory::inventory.stock.name'));

        return view('plugins/inventory::stock.index');
    }
